...
const CSV_COLUMNS = [
  ...
  { key: 'runtimeStarts', label: 'Runtime Starts', get: (r) => r.stats.runtimeStartCount },
  { key: 'reportedRuntimeStarts', label: 'Runtime Starts (app reported)', get: (r) => r.reported.runtimeStarts },
  { key: 'runtimeStartsDisagree', label: 'Runtime Start Counts Disagree', get: (r) => r.stats.runtimeStartsDisagree },
