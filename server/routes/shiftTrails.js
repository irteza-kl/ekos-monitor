...
const CSV_COLUMNS = [
  ...
  { key: 'impossibleSteps', label: 'Discarded Fixes', get: (r) => r.stats.impossibleSteps },
  { key: 'discardedMetres', label: 'Discarded Distance (m)', get: (r) => r.stats.discardedMetres },
  { key: 'shiftMinutes', label: 'Shift Minutes (buckets)', get: (r) => r.stats.shiftMinutes },
